...
def nearest_undisclosed_free(angle):
    ...
    #print("("+str(globy+3*dirY)+","+str(globx+3*dirX)+") : "+str(Map2[globy+3*dirY,globx+3*dirX]))
    #print("("+str(globy+3*dirY+null(dirY))+","+str(globx+3*dirX+null(dirX))+") : "+str(Map2[globy+3*dirY+null(dirY),globx+3*dirX+null(dirX)]))
    #print("("+str(globy+3*dirY-null(dirY))+","+str(globx+3*dirX-null(dirX))+") : "+str(Map2[globy+3*dirY-null(dirY),globx+3*dirX-null(dirX)]))
    i=0
    case1=128
    case2=128
